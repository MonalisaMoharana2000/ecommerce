...
function Termsofservice() {
  return (
    <div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Dhanes Kart.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Dhanes Kart, accessible from [
            http://www.dhanes kart.com]( http://www.dhanes kart.com)
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          <p>By email: dhaneswarsetha123@gmail.com</p>
        </li>
        <li>
          <p>By phone number: 8112158517</p>
        </li>
      </ul>
    </div>
  );
